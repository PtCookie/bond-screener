...
src/
  ...
  lib/
    ...
    snapshot/      # 스크리너 목록 스냅샷 v2 포맷·인코드·디코드·병합·cron 빌드(build.ts) (format.ts/encode.ts/index-file.ts는 @/ 별칭 미사용)
